...
#Adding in landing page, background slider
...
* add a location feature to our application, using the Google Maps API
* get Goole Maps API Key
* add google map scripts to the application
